...
//@version=5
strategy("konk_MELI_q0.197", overlay=true, margin_long=100, margin_short=100, pyramiding=5)
decision_tree_0(azul, marron, verde, media, azul_mean, verde_mean, marron_mean, verde_azul, verde_media, media_azul) =>
	...
	if( verde_azul <= 12.5065 )
		if( azul_mean <= 20.4617 )
			if( marron_mean <= 9.49428 )
				if( verde_mean <= -34.5622 )
					if( verde_media <= -35.4721 )
						ret := 0.476190
					if( verde_media > -35.4721 )
						ret := 2.000000
				if( verde_mean > -34.5622 )
					if( verde_azul <= -14.2706 )
						ret := 1.875000
					if( verde_azul > -14.2706 )
						ret := 1.058824
			if( marron_mean > 9.49428 )
				if( media_azul <= 9.65452 )
					ret := 1.400000
				if( media_azul > 9.65452 )
					if( azul <= -21.714 )
						ret := 2.000000
	...
	if( verde_azul > 12.5065 )
		...
		if( verde > 8.65082 )
			if( media <= 23.5694 )
				if( verde_mean <= 5.11244 )
					ret := 0.133333
				if( verde_mean > 5.11244 )
					ret := 0.642857
			if( media > 23.5694 )
				if( azul_mean <= -13.4332 )
					if( azul <= -45.4001 )
						ret := 1.000000
					if( azul > -45.4001 )
						ret := 1.531646
				if( azul_mean > -13.4332 )
					if( verde_mean <= 17.9105 )
						ret := 0.678571
					if( verde_mean > 17.9105 )
						ret := 1.120240
